...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/omarrasheed/MyTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'omarrasheed' => 'oyr2@cornell.edu' }
  s.source           = { :git => 'https://github.com/omarrasheed/MyTest.git', :tag => s.version.to_s }
